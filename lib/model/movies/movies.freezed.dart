...
// @Default('') @JsonKey(name: 'total') String total,
 ...
 int get page; int get pages;@JsonKey(name: 'tv_shows') List<TvShows> get tvShow;
...
@JsonKey(name: 'name') String get name;@JsonKey(name: 'permalink') String get permalink;@JsonKey(name: 'endDate') String get endDate;@JsonKey(name: 'network') String get network;@JsonKey(name: 'imageThumbnailPath') String get imageThumbnailPath;@JsonKey(name: 'status') String get status;
...
@useResult
$Res call({
@JsonKey(name: 'name') String name,@JsonKey(name: 'permalink') String permalink,@JsonKey(name: 'endDate') String endDate,@JsonKey(name: 'network') String network,@JsonKey(name: 'imageThumbnailPath') String imageThumbnailPath,@JsonKey(name: 'status') String status
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'name')  String name, @JsonKey(name: 'permalink')  String permalink, @JsonKey(name: 'endDate')  String endDate, @JsonKey(name: 'network')  String network, @JsonKey(name: 'imageThumbnailPath')  String imageThumbnailPath, @JsonKey(name: 'status')  String status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TvShows() when $default != null:
...
class _TvShows implements TvShows {
   _TvShows({@JsonKey(name: 'name') this.name = '', @JsonKey(name: 'permalink') this.permalink = '', @JsonKey(name: 'endDate') this.endDate = '', @JsonKey(name: 'network') this.network = '', @JsonKey(name: 'imageThumbnailPath') this.imageThumbnailPath = '', @JsonKey(name: 'status') this.status = ''});
...
@override@JsonKey(name: 'imageThumbnailPath') final  String imageThumbnailPath;
